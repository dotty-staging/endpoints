  ...
  crossProject(JSPlatform, JVMPlatform)
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ("org.scala-lang.modules" %%% "scala-collection-compat" % "2.3.2").cross(CrossVersion.for3Use2_13),
        ("org.scalacheck" %%% "scalacheck" % "1.15.2" % Test).cross(CrossVersion.for3Use2_13)
      ),
...
lazy val `json-schema-generic` =
  crossProject(JSPlatform, JVMPlatform)
    ...
    .settings(
      ...
      libraryDependencies += ("com.chuusai" %%% "shapeless" % "2.3.3").cross(CrossVersion.for3Use2_13),
      addScalaTestCrossDependency,
